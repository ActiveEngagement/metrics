...
use Actengage\Metrics\PartitionColors;
use Actengage\Metrics\RoundingPrecision;
use Actengage\Metrics\TransformsResults;
use Closure;

class PartitionResult implements Result
{
    use RoundingPrecision, TransformsResults;
